...
for event in VkLongPoll(session).listen():
    if event.type == VkEventType.MESSAGE_NEW and event.to_me:
        ...
        if text == "начать":
            send_message(user_id, "Добро пожаловать в нашу группу, где искусство встречается с модой, а вдохновение берется из "
                                  "различных уголков эстетики. Мы предлагаем эксклюзивные вещи как из готовой линейки,"
                                  " вдохновленные такими направлениями, как Goblincore, Dark Academia, Cottagecore и "
                                  "многими другими, так и вещи сделанные на заказ по вашим требованиям. "
                                  "Здесь каждая вещь - это не просто предмет гардероба, это отражение вашего уникального 'я '. "
                                  "Погрузитесь в мир, где стиль говорит громче слов.", keyboard)
            ...
            send_message(user_id, "Хотите что-то поистине уникальное, что-то? Что-то, что будет олицетворять вашу Вселенную? \n"
                                  " Вы обратились по адресу! Опишите, что выхотите изменить в готовой продукции и"
                                  " мы с радостью поможем вам воплотить в жизнь ваши фантазии!", keyboard)
